...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-outseta.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-outseta)
...
```bash
php artisan vendor:publish --tag="laravel-outseta-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-outseta-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-outseta-views"
```

## Usage

```php
$outseta = new RefBytes\Outseta();
echo $outseta->echoPhrase('Hello, RefBytes!');
```
